      ...
      <div className="flex-grow flex flex-col pb-20 relative">
        ...
        <div className="flex flex-col items-center justify-center px-4 pt-20 text-center max-w-5xl mx-auto relative z-10">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-7xl font-bold mt-6 leading-tight dark:text-white"
          >
          ...
          <motion.p
            ...
            className="text-gray-500 dark:text-gray-400 mt-6 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed font-medium px-2"
          >
        ...
        <div className="max-w-6xl w-full mx-auto px-6">
          ...
          {/* Step Flow Section */}
          <div className="mt-16 sm:mt-28 flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8">
            {[
              {
                step: "STEP 1",
          ...
          <div className="mt-20 sm:mt-40">
            <h2 className="text-2xl sm:text-4xl font-bold text-center dark:text-white">
              Advanced AI <span className="text-green-500">Capabilities</span>
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mt-8 sm:mt-14">
              {[
                {
                ...
                >
                  <img
                    src={item.image}
                    alt=""
                    className="w-24 h-20 sm:w-40 sm:h-32 object-contain flex-shrink-0 mx-auto sm:mx-0"
                  />
              ...
              {[
                ...
                >
                  ...
                  <img
                    src={item.image}
                    alt=""
                    className="w-20 h-20 sm:w-28 sm:h-28 object-contain flex-shrink-0 mx-auto sm:mx-0"
                  />
                </motion.div>
              ))}
            </div>
